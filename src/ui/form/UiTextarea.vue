<template>
  <div class="relative w-full">
    ...
    <textarea
      ...
      :rows="rows"
      class="peer w-full px-3 pt-4 pb-2 border-none rounded-2xl resize-none bg-light-overlay dark:bg-dark-overlay text-light-text-primary dark:text-dark-text-primary focus:outline-none focus:ring-2 focus:ring-primary/70 focus:border-primary shadow-sm transition-all duration-200"
    ></textarea>
