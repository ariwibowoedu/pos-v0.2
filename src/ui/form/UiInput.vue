<template>
  <div class="relative w-full">
    ...
    <input
      ...
      :required="required"
      class="peer w-full px-3 pt-4 pb-2 border-none rounded-2xl focus:outline-none focus:ring-2 focus:ring-primary transition bg-transparent text-light-text-primary dark:text-dark-text-primary bg-light-overlay dark:bg-dark-overlay"
      :class="
        error
