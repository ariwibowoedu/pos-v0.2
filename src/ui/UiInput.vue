<template>
  <div class="relative w-full">
    ...
    <input
      ...
      :required="required"
      class="peer w-full px-3 pt-4 pb-2 border border-light-overlay dark:border-dark-overlay rounded-2xl focus:border-none focus:outline-none focus:ring-2 focus:ring-primary transition bg-light-surface dark:bg-dark-surface text-light-text-primary dark:text-dark-text-primary bg-light-overlay dark:bg-dark-overlay"
      :class="
        error
    ...
    <button
      ...
      class="absolute flex items-center justify-center w-9 h-9 rounded-lg hover:bg-gray-200 hover:dark:bg-gray-700 transition"
      :class="error ? 'top-6 right-3 -translate-y-1/2' : 'top-1/2 right-3 -translate-y-1/2'"
